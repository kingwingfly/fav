...
// @@protoc_insertion_point(message:config.Cookie)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Cookie {
    // message fields
    // @@protoc_insertion_point(field:config.Cookie.DedeUserID)
    pub DedeUserID: ::std::string::String,
    // @@protoc_insertion_point(field:config.Cookie.DedeUserID__ckMd5)
    pub DedeUserID__ckMd5: ::std::string::String,
    // @@protoc_insertion_point(field:config.Cookie.SESSDATA)
    pub SESSDATA: ::std::string::String,
    // @@protoc_insertion_point(field:config.Cookie.bili_jct)
    pub bili_jct: ::std::string::String,
    // special fields
    // @@protoc_insertion_point(special_field:config.Cookie.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0cconfig.proto\x12\x06config\"\x8b\x01\n\x06Cookie\x12\x1e\n\nDedeUs\
    erID\x18\x01\x20\x01(\tR\nDedeUserID\x12*\n\x11DedeUserID__ckMd5\x18\x02\
    \x20\x01(\tR\x0fDedeUserIDCkMd5\x12\x1a\n\x08SESSDATA\x18\x03\x20\x01(\t\
    R\x08SESSDATA\x12\x19\n\x08bili_jct\x18\x04\x20\x01(\tR\x07biliJctb\x06p\
    roto3\
";
